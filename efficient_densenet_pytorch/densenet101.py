...
class faceDataset(VisionDataset):
    def __init__(self, root, train=True, transform=None, target_transform=None,
        ...
        '''data and labels'''
        imgspaths = []
        txt_file = '../dataset/ppgtxt/train.txt'
        f = open(txt_file)
...
class facetestDataset(VisionDataset):
    def __init__(self, root, train=True, transform=None, target_transform=None,
        ...
        '''data and labels'''
        imgspaths = []
        txt_file = '../dataset/ppgtxt/test.txt'
        f = open(txt_file)
        for line in f.readlines():
            filename = line.split(',')[0]
            hr = line.split(',')[1]
...
def train(model, train_set, valid_set, test_set, save, n_epochs=50,
...
#############################valid_size
def demo(data='./', save='./output101', depth=100, growth_rate=12, efficient=True, valid_size=None,
         n_epochs=50, batch_size=64, seed=None):
    """
