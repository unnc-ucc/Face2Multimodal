    ...
    for epoch in range(n_epochs):
        ...
        if valid_loader:
            if valid_error < best_error:
                ...
                torch.save(model.state_dict(), os.path.join(save, str(epoch) + 'model.dat'))
                torch.save(model.state_dict(), os.path.join(save, str(epoch) + 'mod.pkl'))
        else:
...
#############################valid_size
def demo(data='./', save='./', depth=100, growth_rate=12, efficient=True, valid_size=None,
